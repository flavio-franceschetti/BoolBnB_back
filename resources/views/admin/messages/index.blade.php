...
<div class="container-fluid">
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <th class="card-text" scope="row">{{ $message->apartment->title }}</th>
                <td class="card-text">{{ $message->name }} {{ $message->surname }}</td>
                <td class="card-text">{{ $message->email }}</td>
                <td class="card-text text-truncate" style="max-width: 600px;">{{ $message->content }}</td>
                <td class="card-text">
